...
/* same namespace */
use TYPO3\TestingFramework\Core\Acceptance\Helper\FileTree;
use TYPO3\TestingFramework\Core\Acceptance\Helper\Login;
use TYPO3\TestingFramework\Core\Acceptance\Helper\PageTree;
...
class Navigation extends Module
{
    ...
    protected function getFullPageSizeOfBackend(): array
    {
        ...
        if ($this->_isOnMainFrame()) {
            ...
            $scrollHeights[] = $pageTree->_getPageTreeToolbarHeight() + $pageTree->_getPageTreeScrollHeight();
            $scrollHeights[] = $fileTree->_getFileTreeToolbarHeight() + $fileTree->_getFileTreeScrollHeight();
    ...
    protected function getPageTree(): PageTree
    {
        return $this->getModule(PageTree::class);
    }

    protected function getFileTree(): FileTree
    {
        return $this->getModule(FileTree::class);
    }
