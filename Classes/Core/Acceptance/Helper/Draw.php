...
NOWDOC;
    ...
    public function clearDrawings(): void
    {
        ...
        if ($navigation->_isOnInstallationProcessPage()) {
    ...
    protected function clearDrawingsOfBackend(): void
    {
        ...
        if ($navigation->_isOnMainFrame()) {
            $this->clearDrawingsOfIFrame();
            $navigation->switchToContentFrame();
            $this->clearDrawingsOfIFrame();
            $navigation->switchToMainFrame();
        } else {
            $this->clearDrawingsOfIFrame();
            if ($navigation->_hasMainFrame()) {
                $navigation->switchToMainFrame();
                $this->clearDrawingsOfIFrame();
                $navigation->switchToContentFrame();
            }
